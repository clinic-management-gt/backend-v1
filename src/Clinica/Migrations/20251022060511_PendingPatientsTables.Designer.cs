...
namespace Clinica.Migrations
{
    ...
    [Migration("20251022060511_PendingPatientsTables")]
    partial class PendingPatientsTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Clinica.Models.EntityFramework.PendingPatientContact", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pending_patient_contacts_pkey");

                    b.HasIndex("PendingPatientId");

                    b.ToTable("pending_patient_contacts", (string)null);
                });

            modelBuilder.Entity("Clinica.Models.EntityFramework.PendingPatientEmail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pending_patient_emails_pkey");

                    b.HasIndex("PendingPatientContactId");

                    b.ToTable("pending_patient_emails", (string)null);
                });
            ...
            modelBuilder.Entity("Clinica.Models.EntityFramework.PendingPatientPhone", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pending_patient_phones_pkey");

                    b.HasIndex("PendingPatientContactId");

                    b.ToTable("pending_patient_phones", (string)null);
                });
            ...
            modelBuilder.Entity("Clinica.Models.EntityFramework.PendingPatientContact", b =>
                {
                    b.Navigation("PendingPatientEmails");

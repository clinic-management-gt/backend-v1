...
public static class DatabaseSeeder
{
    ...
    {
        var firstNames = new[] { "Juan", "María", "Pedro", "Ana", "Carlos", "Lucía", "José", "Carmen", "Miguel", "Isabel", "Francisco", "Teresa", "Antonio", "Rosa", "Manuel", "Patricia", "Javier", "Laura", "Diego", "Sofía", "Alejandro", "Elena", "Fernando", "Marta", "Roberto", "Cristina", "Andrés", "Beatriz", "Pablo", "Raquel", "Sergio", "Silvia", "Rafael", "Alisson", "Alberto", "Natalia", "Gonzalo", "Victoria", "Óscar", "Andrea", "Rubén", "Clara", "Iván", "Nuria", "Adrián", "Eva", "Álvaro", "Julia", "Marcos", "Irene" };
        var lastNames = new[] { "García", "Rodríguez", "González", "Fernández", "López", "Aquino", "Sánchez", "Pérez", "Gómez", "Martín", "Jiménez", "Ruiz", "Hernández", "Díaz", "Moreno", "Muñoz", "Álvarez", "Romero", "Alonso", "Gutiérrez", "Navarro", "Torres", "Domínguez", "Vázquez", "Ramos", "Gil", "Ramírez", "Serrano", "Blanco", "Suárez", "Molina", "Castro", "Ortiz", "Rubio", "Marín", "Sanz", "Iglesias", "Nuñez", "Medina", "Garrido" };
